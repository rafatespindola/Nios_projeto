...
module first_nios2_system_mm_interconnect_0 (
	...
	wire  [93:0] sw_pio_s1_agent_rf_source_data;                                            // sw_pio_s1_agent:rf_source_data -> sw_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] sw_pio_s1_agent_rsp_fifo_out_data;                                         // sw_pio_s1_agent_rsp_fifo:out_data -> sw_pio_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> sw_pio_s1_agent:cp_valid
	wire  [92:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> sw_pio_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // sw_pio_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> sw_pio_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> sw_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> sw_pio_s1_agent:cp_endofpacket
	...
	wire         sw_pio_s1_agent_rp_valid;                                                  // sw_pio_s1_agent:rp_valid -> router_008:sink_valid
	wire  [92:0] sw_pio_s1_agent_rp_data;                                                   // sw_pio_s1_agent:rp_data -> router_008:sink_data
	wire         sw_pio_s1_agent_rp_ready;                                                  // router_008:sink_ready -> sw_pio_s1_agent:rp_ready
	wire         sw_pio_s1_agent_rp_startofpacket;                                          // sw_pio_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         sw_pio_s1_agent_rp_endofpacket;                                            // sw_pio_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         sw_pio_s1_agent_rdata_fifo_src_valid;                                      // sw_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] sw_pio_s1_agent_rdata_fifo_src_data;                                       // sw_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         sw_pio_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_006:in_0_ready -> sw_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> sw_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> sw_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // sw_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> sw_pio_s1_agent:rdata_fifo_sink_error
